        ...
        return (
            <div className="wc-video-child-main-ui">
                <div className={"wc-video-poster "+ this.state.playBtnShow } onTouchTap={()=>{this.props.container!=='live-video' && this.props.startPlay()}} id={this.props.container} style={posterStyle} >
                    ...
                    {this.props.videoObj.videoSrc  && this.props.container !=='live-video' && <video  ref='video' width={this.viewW} height={this.viewW * this.props.scale} style={{position:'absolute',left:0,zIndex:10,display:this.props.videoShow?'block':'none',background:'#000'}}  >
